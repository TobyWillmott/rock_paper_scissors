...
class Game:
    ...
    def __init__(self, allowable_objects=None, win_dict=None, current_round=0, max_rounds=None, round_result=None,
                 round_winner=None):
    ...
    def is_finished(self):
        ...
        return self.max_rounds == self.current_round
    ...
    def report_round(self):
        ...
        msg = f"{self.players[0].name} choose '{self.players[0].current_object.name}'.\nComputer choose '{self.players[1].current_object.name}'.\n"
        if self.round_result == "draw":
            msg += "Round was a draw"
        elif self.round_result == "win":
            msg += f"{self.round_winner.name} won this round"
        return msg
    ...
    def report_winner(self):
        ...
        if self.players[0].score > self.players[1].score:
            out = f"{self.players[0].name} is the winner"
        elif self.players[0].score < self.players[1].score:
            out = f"{self.players[1].name} is the winner"
        else:
            out = "Game is drawn"
        return out
